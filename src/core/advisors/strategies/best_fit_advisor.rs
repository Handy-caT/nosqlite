...
mod tests {
    ...
    fn test_best_fit_advisor_new() {
        ...
        let tree = BalancedTree::<PageLink, DefaultTreeVec<PageLink>>::new_with_compare(nodes, PageLink::compare_by_len);

        let dec_tree = DecoratableBalancedTree::<PageLink, DefaultTreeVec<PageLink>, BalancedTree<PageLink, DefaultTreeVec<PageLink>>>::new(tree, PageLink::compare_by_index);

        let mut registry = EmptyLinkRegistry::< DefaultTreeVec<PageLink>, BalancedTree<PageLink, DefaultTreeVec<PageLink>>>::new(dec_tree);
